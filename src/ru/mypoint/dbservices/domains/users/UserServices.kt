...
import ru.mypoint.dbservices.domains.common.BaseService
 ...
 */
class UserService(private val collection: CoroutineCollection<UserRepository>): BaseService<UserRepository>(collection) {
